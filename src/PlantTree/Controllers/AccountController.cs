...
using PlantTree.Models.AccountViewModels;
...
namespace PlantTree.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var username = _configuration["webadmin:login"];
            var pass = _configuration["webadmin:password"];
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            //DefaultAuthenticationManager man = new DefaultAuthenticationManager(HttpContext);
            //AuthenticateContext auth = new AuthenticateContext("Identity.External");
            //await man.AuthenticateAsync(auth);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var callbackUrl = Url.Action("ResetPassword", "Account", new { mail = user.Email, code }, protocol: HttpContext.Request.Scheme);
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult ResetPassword(string mail = null, string code = null)
        {
            ViewBag.Email = mail;
