        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Donated = table.Column<decimal>(nullable: false),
                    DonatedProjectsCount = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ProjectUsers_ProjectId_UserId", x => new { x.ProjectId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreePlantedCount = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonatorsCount = table.Column<int>(nullable: false),
                    FinishedDate = table.Column<DateTime>(nullable: false),
                    Goal = table.Column<int>(nullable: false),
                    ImageId = table.Column<int>(nullable: true),
                    Name = table.Column<string>(nullable: false),
                    Reached = table.Column<int>(nullable: false),
                    ReachedDate = table.Column<DateTime>(nullable: false),
                    ShortDescription = table.Column<string>(nullable: true),
                    Status = table.Column<int>(nullable: false),
                    Tag = table.Column<string>(nullable: true),
                    TreePrice = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CreationDate",
                table: "Transactions",
                column: "CreationDate");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FinishedDate",
                table: "Transactions",
                column: "FinishedDate");
